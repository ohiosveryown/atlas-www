<template>
  <div ref="index" class="app width">
    <header-md
      ...
      heading="Pricing"
      subheading="Choose a plan that works for you and your team."
    />
    ...
    <main class="enter width">
      <ul class="pricing-cards-container">
        <li class="pricing-card">
          ...
          <footer>
            <button class="inter tertiary">Get the Startup Plan</button>
          </footer>
        </li>
        ...
        <li class="pricing-card">
          <div class="icon-label">
            <img
              ...
              alt=""
            />
            <!-- <span class="inter">Best Value</span> -->
          </div>

          <header>
            <h2 class="inter">Growth</h2>
            <div class="pricing-card-price">
              <h3 class="inter">$50</h3>
              <span>per seat, per month</span>
            </div>
          </header>
          ...
          <footer>
            <button class="inter button-primary">
              🪴 Get the Growth Plan 🪴
            </button>
          </footer>
        </li>
        ...
        <li class="pricing-card">
          ...
          <header>
            <h2 class="inter">Enterprise</h2>
            <div class="pricing-card-price">
              <h3 class="inter">$80</h3>
              <span>per seat, per month</span>
            </div>
          </header>
...
<style lang="scss" scoped>
  ...
  .pricing-card:nth-of-type(2) {
    box-shadow: 0px -24px 68px -16px rgba(145, 101, 249, 0.24);
  }
